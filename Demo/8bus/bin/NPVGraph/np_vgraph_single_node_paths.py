...
def saveXML(attack_graph, filename):
    ...
    for attacker in attack_graph.keys():
        ...
        if attacker is None:#or attack_graph[attacker] is None:
            continue
        if attack_graph[attacker] is None:
...
def compute_attack():
    ...
    fName = "E:\\CyPsaProduction\\projects\\8bus\\attack_graph\\attack_graph-"+t+".xml"
